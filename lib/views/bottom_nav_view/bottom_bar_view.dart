import 'package:event_m/views/home/home_screen.dart';
...
class BottomBarView extends StatefulWidget {
  final bool isAdmin;
   ...
   BottomBarView({Key? key, this.isAdmin = false}) : super(key: key);
...
class _BottomBarViewState extends State<BottomBarView> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.isAdmin) {
      widgetOption[4] = AdminPage(); // Replace ProfileScreen with AdminPage
    }
